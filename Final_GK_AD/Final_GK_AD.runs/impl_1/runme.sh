...
HD_PWD='C:/Users/gik4/Downloads/ECE350_FinalProject/350-final-project/Final_GK_AD/Final_GK_AD.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log stepper_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source stepper_test.tcl -notrace
